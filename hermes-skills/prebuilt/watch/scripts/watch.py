...
Print a Markdown report containing frame paths and a timestamped transcript for
an image-capable agent runtime to inspect and synthesize.
"""
...
def main() -> int:
    ...
    if frames:
        ...
        print()
        print(
            "**Open each frame path below with the runtime's image-capable file reader.** "
