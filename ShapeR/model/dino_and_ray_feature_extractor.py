...
class DinoAndRayFeatureExtractor(torch.nn.Module):
    ...
    def __post_init__(self):
        super().__init__()
        # Breadboard's disposable Runtime worker supplies a durable, data-root
        # cache. The fallback preserves upstream command-line behavior.
        torch.hub.set_dir(os.environ.get("SHAPER_TORCH_HUB_DIR", "/tmp/dinov2"))
