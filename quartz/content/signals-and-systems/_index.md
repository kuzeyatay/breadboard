...
date: "2026-07-04"
description: "Learning garden with 2 source documents, 0 lesson pages, and 821 graph links."
knowledge_type: "cluster-index"
---

## Garden overview

This learning garden is organized from 2 source documents into a sequence of linked lessons. It currently contains 0 lesson pages, 821 graph links, and 296320 indexed words.
...
- **Signals and Systems Full Notes: Sinusoids, Spectra, Sampling, Aliasing, and FIR Filters**
  ...
  - [[product-to-sum-method-for-zero-crossings|Product-to-Sum Method for Zero Crossings]]
  ...
  - [[reduction-example-with-numeric-transfer-functions|Reduction Example with Numeric Transfer Functions]]
