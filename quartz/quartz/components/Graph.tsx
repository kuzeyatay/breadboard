...
export default ((opts?: Partial<GraphOptions>) => {
  const Graph: QuartzComponent = ({ displayClass, cfg, fileData }: QuartzComponentProps) => {
    ...
    const rawGraphClusters = fm?.graph_clusters
    const hasGraphClusterScope = Array.isArray(rawGraphClusters)
    const includeClusters = hasGraphClusterScope
      ? rawGraphClusters.filter(
