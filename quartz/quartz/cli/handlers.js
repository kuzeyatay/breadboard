    ...
    const server = http.createServer(async (req, res) => {
      ...
      const serve = async () => {
        ...
        try {
          ...
          const notFoundPath = path.join(argv.output, "404.html")
          if (!res.headersSent) {
          ...
          console.log(styleText("red", `[404]`) + styleText("gray", ` ${argv.baseDir}${req.url}`))
          console.log(styleText("gray", err instanceof Error ? err.message : String(err)))
        } finally {
