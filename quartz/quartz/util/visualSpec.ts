import { TRUSTED_RENDERER_IDS } from "./visualizationRegistry"
 ...
 *
 * NOTE: this module is dependency-free on purpose. A mirrored copy lives at
 * dashboard/src/lib/visual-spec.ts — keep the two in sync.
 */
