...
class OpenRouterProvider:
    ...
    def call_model(self, call: ModelCall) -> str:
        ...
        try:
            response = requests.post(
                ...
                headers={
                    ...
                    # OpenRouter attributes traffic with this; optional but documented.
        ...
        if response.status_code >= 400:
            # The body may echo sensitive detail, so the message stays generic.
        ...
        if isinstance(content, list):
            # Some models return a list of content parts; join the text ones.
            content = "".join(
