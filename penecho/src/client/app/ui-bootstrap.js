// Pointer and control bindings, portable snapshots, and application startup.
  ...
  fit();
  setNavigating(true);
  startBreadboardBoard();
  // The tour and changelog belong to the standalone app; an embedded Breadboard
  // board is a card on someone else's page and opens straight into the canvas.
  requestAnimationFrame(() => requestAnimationFrame(() => {
    if (!boardRequested()) maybeStartOnboarding();
  }));
})();
