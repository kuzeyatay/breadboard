...
test("the browser application is maintained as six ordered source sections", () => {
  assert.deepEqual(SOURCES, [
    ...
    // The Breadboard board binding: reads and writes the one board named in the
    // URL. After persistence, whose snapshot functions it drives, and before the
    // bootstrap that starts it.
    "src/client/app/breadboard-board.js",
