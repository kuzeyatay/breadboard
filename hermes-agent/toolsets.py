...
_HERMES_CORE_TOOLS = [
    ...
    # Planning & memory
    "todo", "memory",
    # Recover text elided from a compressed tool result. Belongs in every
    # posture: compression can happen to the output of any tool, so the way
    # back has to be reachable wherever that tool is.
    "expand_output",
...
TOOLSETS = {
    ...
    "tokenjuice": {
        "description": "Recover text elided from compressed tool results",
        "tools": ["expand_output"],
        "includes": []
    },
    ...
    "debugging": {
        ...
        "tools": ["terminal", "process", "expand_output"],
