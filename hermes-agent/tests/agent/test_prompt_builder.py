...
def test_default_agent_identity_names_bread_and_keeps_runtime_separate():
    from agent.prompt_builder import DEFAULT_AGENT_IDENTITY

    assert DEFAULT_AGENT_IDENTITY.startswith(
        "You are Bread, the Breadboard assistant."
    )
    assert "Hermes Agent by Nous Research is the runtime" in DEFAULT_AGENT_IDENTITY
    assert "not your name" in DEFAULT_AGENT_IDENTITY
