...
class TestBackup:
    def test_qa_isolation_rejects_output_outside_run_root(self, tmp_path, monkeypatch):
        run_root = tmp_path / "qa-run"
        hermes_home = run_root / "data" / "hermes"
        ...
        with pytest.raises(SystemExit):
            run_backup(Namespace(output=str(outside)))
