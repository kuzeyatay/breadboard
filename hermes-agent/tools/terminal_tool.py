...
def _get_env_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "docker_security_profile": os.getenv(
            "TERMINAL_DOCKER_SECURITY_PROFILE", "standard"
        ),
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    docker_security_profile = cc.get("docker_security_profile", "standard")
    ...
    if env_type == "local":
        ...
        return _DockerEnvironment(
            ...
            security_profile=docker_security_profile,
