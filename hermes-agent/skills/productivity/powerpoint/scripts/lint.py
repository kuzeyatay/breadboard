...
slow and unreliable at catching:
    ...
    FONT      run font not in the known cross-platform set
...
# Common cross-platform fonts (or metric-compatible substitutes), per SKILL.md.
KNOWN_FONTS = {
    "inter",
    "montserrat",
    "lato",
                ...
                for name in names:
                    ...
                    findings.append(
                        Finding(
                            ...
                            "WARN",
                            "FONT",
                            f'font "{name}" is outside the linter\'s known '
                            "cross-platform/embedded set; verify its rendering",
                        )
                    )
    return findings
