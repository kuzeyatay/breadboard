...
//
// Dependencies are resolved from local Node modules first, with a globally
// provisioned module directory retained as a compatibility fallback. They
// require no API key.
"use strict";
...
const MISSING_DEPS_MESSAGE = `Error: packaged icon-rendering dependencies are missing. Run scripts/preflight.py and use the OfficeCLI or shape-only fallback; do not install packages during a deck run.`;
