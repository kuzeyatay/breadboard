    ...
    def _run_real_turn(self, frame: dict[str, Any]) -> None:
        ...
        try:
            ...
            server._run_prompt_submit(
                ...
                session,
                text,
                client_turn_id=str(frame.get("client_turn_id") or "") or None,
            )
    ...
    def _ensure_server_session(self, server: Any, frame: dict[str, Any]) -> dict:
        ...
        try:
            ...
            agent = server._make_agent(
                ...
                enabled_toolsets_override=frame.get("enabled_toolsets_override"),
                ephemeral_system_prompt_override=frame.get(
