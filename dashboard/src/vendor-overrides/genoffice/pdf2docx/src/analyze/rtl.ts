...
// Keep this converter independent of other packages' ambient bidi-js types.
...
let bidiSingleton: BidiRuntime | null = null
const getBidi = (): BidiRuntime =>
  (bidiSingleton ??= bidiFactory() as unknown as BidiRuntime)
