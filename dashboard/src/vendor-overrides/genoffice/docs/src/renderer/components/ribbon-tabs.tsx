          ...
          >
            <span className="rb-big-icon">
              <span className="ai-feature-icon" aria-hidden="true">
                <img src={typeof iconEditor === 'string' ? iconEditor : iconEditor.src} width={22} height={22} alt="" />
              </span>
            </span>
        ...
        <div className="ribbon-group-items">
          <div className="rb-split-wrap">
            ...
            >
              <span className="rb-big-icon">
                <span className="ai-feature-icon" aria-hidden="true">
                  <img src={typeof iconTranslate === 'string' ? iconTranslate : iconTranslate.src} width={22} height={22} alt="" />
                </span>
                <IconCaret />
              </span>
