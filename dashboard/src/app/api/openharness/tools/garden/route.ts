...
// Internal server-to-server endpoint invoked by the OpenHarness garden/quartz
...
// model-supplied garden id cannot escape it. Only the OpenHarness process that
