...
import { getEventsSince, isTerminal } from "@/lib/meeting-notes/run-manager.ts";
...
export async function GET(
  ...
  try {
    ...
    // A reopened transcript asks for the whole log as plain JSON: the run has
    // long finished, and what it wants back is the notes, not a stream.
