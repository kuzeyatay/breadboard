...
import { abortRun } from "@/lib/paper-trader/run-manager.ts";

export const dynamic = "force-dynamic";
export const runtime = "nodejs";

/**
 * Abandon the instruction, not the desk. Stopping a desk is its own instruction
 * — see the note in the run manager.
 */
