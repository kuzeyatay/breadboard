...
import { AuthBoard, AuthCardCorners } from '../auth-board';
...
export default function RegisterPage() {
  ...
  return (
    <div className="auth-page-shell bb-auth-shell min-h-screen bg-gray-950 flex items-center justify-center px-4 py-10">
      <AuthBoard sheet="AUTH-02 · NEW ACCOUNT" />

      <div className="bb-auth-card relative z-10 w-full max-w-sm">
        <AuthCardCorners />
        <div className="neu-surface-raised rounded-2xl border border-gray-800 bg-gray-900 p-6 sm:p-7">
