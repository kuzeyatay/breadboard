// Goal Mode is Breadboard's conversation-scoped integration of the cloned
...
/** Render the upstream Goal continuation contract with this conversation's state. */
export function goalModeSection(
  ...
  return [
    "# goal_mode",
    "Goal Mode is enabled for this Breadboard conversation. Its state is per-conversation and uses the cloned goal project's goal_state.json contract.",
    `Current status: ${state.status}.`,
    "The active goal was created by the user's Goal Mode action. Do not call create_goal for it.",
