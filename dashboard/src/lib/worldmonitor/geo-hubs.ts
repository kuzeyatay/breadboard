...
/** Strategic locations a headline can be pinned to. Verbatim from upstream. */
export const GEO_HUBS: GeoHubLocation[] = [
  // ── Critical Capitals ────────────────────────────────────────
...
export const GEO_HUB_BY_ID = new Map(GEO_HUBS.map((hub) => [hub.id, hub]));
