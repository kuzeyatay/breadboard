// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/serializer/types.ts; adapted for Breadboard.
import type { BlockRetryConfig } from '@/lib/sim/workflow-types/workflow'
import type { OutputFieldDefinition, ParamType } from '@/lib/sim/blocks/types'
import type { Position } from '@/lib/sim/core/stores/workflows/workflow/types'
