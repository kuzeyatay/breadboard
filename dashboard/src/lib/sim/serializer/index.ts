// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/serializer/index.ts; adapted for Breadboard.
...
import { resolveBlockRetryConfig } from '@/lib/sim/workflow-types/workflow'
import type { Edge } from 'reactflow'
import type { CanonicalModeOverrides } from '@/lib/sim/core/workflows/subblocks/visibility'
import {
  buildCanonicalIndex,
  buildSubBlockValues,
...
import { isCustomBlockType, RESERVED_PARAMS } from '@/lib/sim/blocks/custom/build-config'
...
import type { BlockState, Loop, Parallel } from '@/lib/sim/core/stores/workflows/workflow/types'
import { generateLoopBlocks, generateParallelBlocks } from '@/lib/sim/core/stores/workflows/workflow/utils'
import { getToolParams } from '@/lib/sim/core/tools-shim/metadata'
