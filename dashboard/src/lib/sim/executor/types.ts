// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/types.ts; adapted for Breadboard.
import type { BillingAttributionSnapshot } from '@/lib/sim/core/billing/core/billing-attribution'
import type { TraceSpan } from '@/lib/sim/core/logs/types'
import type { PermissionGroupConfig } from '@/lib/sim/core/permission-groups/types'
...
import type { RunFromBlockContext } from '@/lib/sim/executor/utils/run-from-block'
import type { AgentStreamSink, UnsubscribeAgentStreamSink } from '@/lib/sim/providers/stream-events'
