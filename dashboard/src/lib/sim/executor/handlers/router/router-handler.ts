// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/router/router-handler.ts; adapted for Breadboard.
...
import type { ResolvedSecretInputPath } from '@/lib/sim/executor/utils/resolved-secret-trace-registry'
