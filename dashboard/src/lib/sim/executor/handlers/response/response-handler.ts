// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/response/response-handler.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { BlockType, HTTP } from '@/lib/sim/executor/constants'
import type { BlockHandler, ExecutionContext, NormalizedBlockOutput } from '@/lib/sim/executor/types'
import {
  convertBuilderDataToJson,
  convertBuilderDataToJsonString,
} from '@/lib/sim/executor/utils/builder-data'
