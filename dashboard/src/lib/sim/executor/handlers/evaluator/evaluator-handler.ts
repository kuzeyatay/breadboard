// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/evaluator/evaluator-handler.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { projectResolvedModelInput } from '@/lib/sim/core/execution/model-input-provenance'
import {
...
import { validateModelProvider } from '@/lib/sim/core/ee/access-control/utils/permission-check'
...
import { executeBlockProviderRequest } from '@/lib/sim/executor/utils/provider-request'
...
import { resolveProxiedModelCost } from '@/lib/sim/providers/cost-policy'
import { isAutoModel, SIM_AUTO_MODEL_ID } from '@/lib/sim/providers/models'
import type { ProviderRequest } from '@/lib/sim/providers/types'
import { getProviderFromModel } from '@/lib/sim/providers/utils'
