// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/human-in-the-loop/human-in-the-loop-handler.ts; adapted for Breadboard.
...
} from '@/lib/sim/executor/human-in-the-loop/utils'
import type { BlockHandler, ExecutionContext, PauseMetadata } from '@/lib/sim/executor/types'
import { collectBlockData } from '@/lib/sim/executor/utils/block-data'
import { convertBuilderDataToJson, convertPropertyValue } from '@/lib/sim/executor/utils/builder-data'
import { parseObjectStrings } from '@/lib/sim/executor/utils/json'
