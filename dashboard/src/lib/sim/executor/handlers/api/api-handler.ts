// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/api/api-handler.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { validateUrlWithDNS } from '@/lib/sim/core/core/security/input-validation.server'
