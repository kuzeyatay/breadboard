// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/condition/condition-handler.ts; adapted for Breadboard.
...
import { isElseConditionTitle } from '@/lib/sim/core/workflows/conditions'
import type { BlockOutput } from '@/lib/sim/blocks/types'
import { BlockType, DEFAULTS, EDGE } from '@/lib/sim/executor/constants'
