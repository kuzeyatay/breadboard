// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/generic/generic-handler.ts; adapted for Breadboard.
...
import { getBlock } from '@/lib/sim/blocks/index'
import { isMcpTool } from '@/lib/sim/executor/constants'
import type { BlockHandler, ExecutionContext } from '@/lib/sim/executor/types'
import { readStatusCode } from '@/lib/sim/executor/utils/errors'
