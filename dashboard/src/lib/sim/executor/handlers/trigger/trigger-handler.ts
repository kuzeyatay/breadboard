// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/handlers/trigger/trigger-handler.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { BlockType, isTriggerBehavior, isTriggerInternalKey } from '@/lib/sim/executor/constants'
