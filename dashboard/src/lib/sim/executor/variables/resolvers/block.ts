// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/variables/resolvers/block.ts; adapted for Breadboard.
import { assertNoLargeValueRefs } from '@/lib/sim/core/execution/payloads/large-value-ref'
import {
  isReference,
  normalizeName,
  parseReferencePath,
...
import type { BlockState } from '@/lib/sim/executor/types'
import { getBlockSchema } from '@/lib/sim/executor/utils/block-data'
import {
  InvalidFieldError,
  type OutputSchema,
  resolveBlockReference,
  resolveBlockReferenceAsync,
} from '@/lib/sim/executor/utils/block-reference'
import { formatLiteralForCode } from '@/lib/sim/executor/utils/code-formatting'
import { buildClonedSubflowId, extractOuterBranchIndex } from '@/lib/sim/executor/utils/subflow-utils'
import {
