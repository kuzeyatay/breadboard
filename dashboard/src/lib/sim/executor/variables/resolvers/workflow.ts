// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/variables/resolvers/workflow.ts; adapted for Breadboard.
...
import { assertNoLargeValueRefs, isLargeValueRef } from '@/lib/sim/core/execution/payloads/large-value-ref'
import { VariableManager } from '@/lib/sim/core/workflows/variables/variable-manager'
import { isReference, normalizeName, parseReferencePath, REFERENCE } from '@/lib/sim/executor/constants'
import {
...
import type { VariableType } from '@/lib/sim/core/stores/variables/types'
