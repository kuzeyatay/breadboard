// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/variables/resolvers/reference.ts; adapted for Breadboard.
import {
  materializeLargeValueRefSync,
  materializeLargeValueRefSyncOrThrow,
} from '@/lib/sim/core/execution/payloads/cache'
import {
