// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/variables/resolvers/reference-async.server.ts; adapted for Breadboard.
...
import { hydrateUserFileWithBase64 } from '@/lib/sim/core/uploads/utils/user-file-base64.server'
import type { PathNavigationContext } from '@/lib/sim/executor/variables/resolvers/reference'
