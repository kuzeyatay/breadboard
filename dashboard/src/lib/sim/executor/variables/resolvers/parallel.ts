// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/variables/resolvers/parallel.ts; adapted for Breadboard.
...
import { InvalidFieldError } from '@/lib/sim/executor/utils/block-reference'
import type { ResolvedSecretTraceProvenanceV1 } from '@/lib/sim/executor/utils/resolved-secret-trace-registry'
import {
  extractBranchIndex,
...
import type { SerializedParallel, SerializedWorkflow } from '@/lib/sim/serializer/types'
