// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import type { ResponseFormatStreamProcessor } from '@/lib/sim/executor/types'
