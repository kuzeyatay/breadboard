// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/errors/child-workflow-error.ts; adapted for Breadboard.
import type { TraceSpan } from '@/lib/sim/core/logs/types'
import type { CustomBlockFailure } from '@/lib/sim/executor/errors/boundary'
import type { ExecutionResult } from '@/lib/sim/executor/types'
