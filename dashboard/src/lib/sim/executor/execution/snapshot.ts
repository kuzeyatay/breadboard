// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/snapshot.ts; adapted for Breadboard.
import { normalizeStringArray } from '@/lib/sim/core/core/utils/arrays'
import { normalizeWorkflowVariables } from '@/lib/sim/core/core/utils/records'
