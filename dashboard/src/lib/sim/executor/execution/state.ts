// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/state.ts; adapted for Breadboard.
import type { BlockStateController } from '@/lib/sim/executor/execution/types'
import type { BlockState, NormalizedBlockOutput } from '@/lib/sim/executor/types'
