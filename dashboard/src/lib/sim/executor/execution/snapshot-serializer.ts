// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/snapshot-serializer.ts; adapted for Breadboard.
import { LARGE_VALUE_THRESHOLD_BYTES } from '@/lib/sim/core/execution/payloads/large-value-ref'
import type { DAG } from '@/lib/sim/executor/dag/builder'
import type { EdgeManager } from '@/lib/sim/executor/execution/edge-manager'
import { ExecutionSnapshot } from '@/lib/sim/executor/execution/snapshot'
import type { ExecutionMetadata, SerializableExecutionState } from '@/lib/sim/executor/execution/types'
import type { ExecutionContext, SerializedSnapshot } from '@/lib/sim/executor/types'
import { RESOLVED_SECRET_TRACE_CHECKPOINT_VERSION } from '@/lib/sim/executor/utils/resolved-secret-trace-registry'
