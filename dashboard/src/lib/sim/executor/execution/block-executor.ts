// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/block-executor.ts; adapted for Breadboard.
import { createLogger, type Logger } from '@/lib/sim/core/logger'
import { sleep } from '@/lib/sim/core/utils/helpers'
import { isRecordLike } from '@/lib/sim/core/utils/object'
import { isTimeoutAbortReason } from '@/lib/sim/core/core/execution-limits/types'
import { redactApiKeys } from '@/lib/sim/core/core/security/redaction'
import { normalizeStringArray } from '@/lib/sim/core/core/utils/arrays'
import { getBaseUrl } from '@/lib/sim/core/core/utils/urls'
import { compactExecutionPayload } from '@/lib/sim/core/execution/payloads/serializer'
import { redactLargeValueRefsInValue } from '@/lib/sim/core/logs/execution/pii-large-values'
import { redactObjectStrings } from '@/lib/sim/core/logs/execution/pii-redaction'
import {
  containsUserFileWithMetadata,
  hydrateUserFilesWithBase64,
} from '@/lib/sim/core/uploads/utils/user-file-base64.server'
import { sanitizeInputFormat, sanitizeTools } from '@/lib/sim/core/workflows/comparison/normalize'
import { isCustomBlockType } from '@/lib/sim/blocks/custom/build-config'
import { validateBlockType } from '@/lib/sim/core/ee/access-control/utils/permission-check'
import {
  BlockType,
  buildResumeApiUrl,
  buildResumeUiUrl,
...
import { isRetryableBlockError, resolveBlockRetryPolicy } from '@/lib/sim/executor/execution/block-retry'
import type {
  BlockStateWriter,
  ContextExtensions,
  WorkflowNodeMetadata,
} from '@/lib/sim/executor/execution/types'
import {
  generatePauseContextId,
  mapNodeMetadataToPauseScopes,
} from '@/lib/sim/executor/human-in-the-loop/utils.ts'
import {
  type BlockHandler,
  type BlockLog,
  type BlockState,
...
} from '@/lib/sim/executor/types'
import { streamingResponseFormatProcessor } from '@/lib/sim/executor/utils'
import { buildBlockExecutionError, normalizeError } from '@/lib/sim/executor/utils/errors'
import {
  buildUnifiedParentIterations,
  getIterationContext,
} from '@/lib/sim/executor/utils/iteration-context'
import { isJSONString } from '@/lib/sim/executor/utils/json'
import { filterOutputForLog } from '@/lib/sim/executor/utils/output-filter'
import { projectResolvedSecretDiagnosticError } from '@/lib/sim/executor/utils/resolved-secret-content-projection'
import type {
...
import { createAgentStreamPump } from '@/lib/sim/providers/stream-pump'
