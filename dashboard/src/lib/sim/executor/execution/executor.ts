// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/executor.ts; adapted for Breadboard.
...
import { StartBlockPath } from '@/lib/sim/core/workflows/triggers/triggers'
import type { DAG } from '@/lib/sim/executor/dag/builder'
import { DAGBuilder } from '@/lib/sim/executor/dag/builder'
import { BlockExecutor } from '@/lib/sim/executor/execution/block-executor'
import { EdgeManager } from '@/lib/sim/executor/execution/edge-manager'
import { ExecutionEngine } from '@/lib/sim/executor/execution/engine'
import { ExecutionState } from '@/lib/sim/executor/execution/state'
import type {
  ContextExtensions,
  SerializableExecutionState,
  WorkflowInput,
} from '@/lib/sim/executor/execution/types'
import { createBlockHandlers } from '@/lib/sim/executor/handlers/registry'
import { LoopOrchestrator } from '@/lib/sim/executor/orchestrators/loop'
import { NodeExecutionOrchestrator } from '@/lib/sim/executor/orchestrators/node'
import { ParallelOrchestrator } from '@/lib/sim/executor/orchestrators/parallel'
import type { BlockState, ExecutionContext, ExecutionResult } from '@/lib/sim/executor/types'
import { type ClonedSubflowInfo, ParallelExpander } from '@/lib/sim/executor/utils/parallel-expansion'
import { isResolvedSecretTraceProvenanceV1 } from '@/lib/sim/executor/utils/resolved-secret-trace-registry'
import {
  computeExecutionSets,
  type RunFromBlockContext,
  resolveContainerToSentinelStart,
  validateRunFromBlock,
} from '@/lib/sim/executor/utils/run-from-block'
import {
  buildResolutionFromBlock,
  buildStartBlockOutput,
  resolveExecutorStartBlock,
} from '@/lib/sim/executor/utils/start-block'
import {
...
import { VariableResolver } from '@/lib/sim/executor/variables/resolver'
import { navigatePathAsync } from '@/lib/sim/executor/variables/resolvers/reference-async.server'
import type { SerializedWorkflow } from '@/lib/sim/serializer/types'
import type { SubflowType } from '@/lib/sim/core/stores/workflows/workflow/types'
