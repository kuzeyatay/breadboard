// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/types.ts; adapted for Breadboard.
import type { Edge } from 'reactflow'
import type { BillingAttributionSnapshot } from '@/lib/sim/core/billing/core/billing-attribution'
import type { AsyncExecutionCorrelation } from '@/lib/sim/core/core/async-jobs/types'
import type { CustomPiiPattern } from '@/lib/sim/core/guardrails/pii-entities'
import type { NodeMetadata } from '@/lib/sim/executor/dag/types'
import type {
  BlockLog,
  BlockState,
