// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/engine.ts; adapted for Breadboard.
import { createLogger, type Logger } from '@/lib/sim/core/logger'
import { toError } from '@/lib/sim/core/utils/errors'
import { combineExecutionAbortSignals } from '@/lib/sim/core/core/execution-limits'
import {
  getCancellationChannel,
  isExecutionCancelled,
  isRedisCancellationEnabled,
} from '@/lib/sim/core/execution/cancellation'
import { BlockType, EDGE } from '@/lib/sim/executor/constants'
import type { DAG } from '@/lib/sim/executor/dag/builder'
import type { EdgeManager } from '@/lib/sim/executor/execution/edge-manager'
import { serializePauseSnapshot } from '@/lib/sim/executor/execution/snapshot-serializer'
import type { SerializableExecutionState } from '@/lib/sim/executor/execution/types'
import type { NodeExecutionOrchestrator } from '@/lib/sim/executor/orchestrators/node'
import type {
  ExecutionContext,
  ExecutionResult,
...
import { attachExecutionResult, normalizeError } from '@/lib/sim/executor/utils/errors'
