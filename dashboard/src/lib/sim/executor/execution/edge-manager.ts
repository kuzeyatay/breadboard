// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/execution/edge-manager.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { normalizeWorkflowEdgeSourceHandle } from '@/lib/sim/workflow-types/workflow'
import { CONTROL_BACK_EDGE_HANDLES, EDGE, SUBFLOW_CONTROL_EDGE_HANDLES } from '@/lib/sim/executor/constants'
import type { DAG, DAGNode } from '@/lib/sim/executor/dag/builder'
import type { DAGEdge } from '@/lib/sim/executor/dag/types'
