// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/output-filter.ts; adapted for Breadboard.
import { isLargeValueRef } from '@/lib/sim/core/execution/payloads/large-value-ref'
import { filterHiddenOutputKeys } from '@/lib/sim/core/logs/execution/trace-spans/trace-spans'
import { getBlock } from '@/lib/sim/blocks'
import { isHiddenFromDisplay } from '@/lib/sim/blocks/types'
import { isTriggerBehavior, isTriggerInternalKey } from '@/lib/sim/executor/constants'
import type { NormalizedBlockOutput } from '@/lib/sim/executor/types'
