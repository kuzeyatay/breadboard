// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/provider-request.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { checkWorkspaceAccess } from '@/lib/sim/core/workspaces/permissions/utils'
...
import type { ProviderRequest, ProviderResponse } from '@/lib/sim/providers/types'
