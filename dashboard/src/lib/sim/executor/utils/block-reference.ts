// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/block-reference.ts; adapted for Breadboard.
import { HttpError } from '@/lib/sim/core/core/utils/http-error'
import { USER_FILE_ACCESSIBLE_PROPERTIES } from '@/lib/sim/core/workflows/types'
