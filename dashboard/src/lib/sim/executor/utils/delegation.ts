// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/delegation.ts; adapted for Breadboard.
import type { GenerateInternalDelegationTokenInput } from '@/lib/sim/core/auth/internal'
