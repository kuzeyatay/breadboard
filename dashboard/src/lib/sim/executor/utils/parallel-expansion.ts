// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/parallel-expansion.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { sha256Hex } from '@/lib/sim/core/security/hash'
import { CONTROL_BACK_EDGE_HANDLES, EDGE } from '@/lib/sim/executor/constants'
