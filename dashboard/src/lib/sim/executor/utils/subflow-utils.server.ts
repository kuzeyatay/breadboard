// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/subflow-utils.server.ts; adapted for Breadboard.
import { toError } from '@/lib/sim/core/utils/errors'
import { recordMaterializedAccessKeys } from '@/lib/sim/core/execution/payloads/access-keys'
import {
  isLargeArrayManifest,
  LARGE_ARRAY_MANIFEST_MARKER,
  materializeLargeArrayManifest,
} from '@/lib/sim/core/execution/payloads/large-array-manifest'
import { isLargeValueRef, LARGE_VALUE_REF_MARKER } from '@/lib/sim/core/execution/payloads/large-value-ref'
import { MAX_DURABLE_LARGE_VALUE_BYTES } from '@/lib/sim/core/execution/payloads/limits'
import { materializeLargeValueRef } from '@/lib/sim/core/execution/payloads/store'
import { REFERENCE } from '@/lib/sim/executor/constants'
