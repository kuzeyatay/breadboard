// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/vertex-credential.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { canUseCredential, getCredentialActorContext } from '@/lib/sim/core/credentials/access'
import { getServiceAccountToken } from '@/lib/sim/core/oauth/credential-service'
import { fetchCredentialAccessToken } from '@/lib/sim/executor/utils/credential-token'
