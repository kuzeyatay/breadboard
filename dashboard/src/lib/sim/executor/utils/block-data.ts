// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/block-data.ts; adapted for Breadboard.
import { getEffectiveBlockOutputs } from '@/lib/sim/core/workflows/blocks/block-outputs'
import { hasTriggerCapability } from '@/lib/sim/core/workflows/triggers/trigger-utils'
import { getBlock } from '@/lib/sim/blocks/registry'
import { isTriggerBehavior, normalizeName } from '@/lib/sim/executor/constants'
