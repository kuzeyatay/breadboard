// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/credential-token.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { generateInternalToken } from '@/lib/sim/core/auth/internal'
import { getInternalApiBaseUrl } from '@/lib/sim/core/core/utils/urls'
