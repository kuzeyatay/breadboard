// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/subflow-utils.ts; adapted for Breadboard.
...
import type { ContextExtensions } from '@/lib/sim/executor/execution/types'
import { type BlockLog, type ExecutionContext, getNextExecutionOrder } from '@/lib/sim/executor/types'
import { buildContainerIterationContext } from '@/lib/sim/executor/utils/iteration-context'
import { SubflowNodeIdCodec } from '@/lib/sim/executor/utils/subflow-node-id-codec'
