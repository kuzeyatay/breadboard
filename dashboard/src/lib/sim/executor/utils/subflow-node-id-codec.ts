// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/subflow-node-id-codec.ts; adapted for Breadboard.
import { LOOP, PARALLEL } from '@/lib/sim/executor/constants'
