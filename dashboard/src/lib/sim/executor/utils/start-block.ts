// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/start-block.ts; adapted for Breadboard.
...
import type { InputFormatField } from '@/lib/sim/core/workflows/types'
import {
...
import { safeAssign } from '@/lib/sim/tools/safe-assign'
