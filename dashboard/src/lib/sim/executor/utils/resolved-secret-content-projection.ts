// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/resolved-secret-content-projection.ts; adapted for Breadboard.
import { isDeepStrictEqual } from 'node:util'
import { isPlainRecord } from '@/lib/sim/core/utils/object'
import { LARGE_ARRAY_MANIFEST_MARKER } from '@/lib/sim/core/execution/payloads/large-array-manifest-metadata'
import { LARGE_VALUE_REF_MARKER } from '@/lib/sim/core/execution/payloads/large-value-ref'
