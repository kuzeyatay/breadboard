// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/iteration-context.ts; adapted for Breadboard.
import { DEFAULTS } from '@/lib/sim/executor/constants'
import type { NodeMetadata } from '@/lib/sim/executor/dag/types'
import type { IterationContext, ParentIteration } from '@/lib/sim/executor/execution/types'
import type { ExecutionContext } from '@/lib/sim/executor/types'
import { findEffectiveContainerId } from '@/lib/sim/executor/utils/subflow-utils'
