// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/resolved-secret-trace-registry.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { getErrorMessage } from '@/lib/sim/core/utils/errors'
import { decryptSecret } from '@/lib/sim/core/core/security/encryption'
import { isLargeArrayManifest } from '@/lib/sim/core/execution/payloads/large-array-manifest-metadata'
import { isLargeValueRef } from '@/lib/sim/core/execution/payloads/large-value-ref'
import { MAX_INLINE_MATERIALIZATION_BYTES } from '@/lib/sim/core/execution/payloads/limits'
import { isNonIdentifyingSecretLiteral } from '@/lib/sim/executor/utils/resolved-secret-match-policy'
import {
  createResolvedSecretMatcher,
  OPAQUE_RESOLVED_SECRET_REPLACEMENT,
  type ResolvedSecretMatcher,
  scanResolvedSecretString,
} from '@/lib/sim/executor/utils/resolved-secret-matcher'
import { getResolvedSecretMatcherCapacityFailure } from '@/lib/sim/executor/utils/resolved-secret-matcher-capacity'
