// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/errors.ts; adapted for Breadboard.
import { HttpError } from '@/lib/sim/core/core/utils/http-error'
import type { ExecutionContext, ExecutionResult } from '@/lib/sim/executor/types'
