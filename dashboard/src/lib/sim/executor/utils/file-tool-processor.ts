// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/file-tool-processor.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { toError } from '@/lib/sim/core/utils/errors'
import { isUserFile } from '@/lib/sim/core/core/utils/user-file'
import { uploadExecutionFile, uploadFileFromRawData } from '@/lib/sim/core/uploads/contexts/execution'
import { downloadFileFromUrl } from '@/lib/sim/core/uploads/utils/file-utils.server'
import { MAX_FILE_SIZE, sniffImageContentType } from '@/lib/sim/core/uploads/utils/validation'
import type { ExecutionContext, UserFile } from '@/lib/sim/executor/types'
import type { ToolConfig, ToolFileData } from '@/lib/sim/tools/types'
