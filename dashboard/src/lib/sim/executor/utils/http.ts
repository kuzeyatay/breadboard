// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/utils/http.ts; adapted for Breadboard.
import {
  type GenerateInternalDelegationTokenInput,
  generateInternalDelegationToken,
  generateInternalToken,
} from '@/lib/sim/core/auth/internal'
import { getBaseUrl, getInternalApiBaseUrl } from '@/lib/sim/core/core/utils/urls'
import { HTTP } from '@/lib/sim/executor/constants'
