// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/orchestrators/loop.ts; adapted for Breadboard.
...
import { compactSubflowResults } from '@/lib/sim/core/execution/payloads/serializer'
...
import type { EdgeManager } from '@/lib/sim/executor/execution/edge-manager'
import type { LoopScope } from '@/lib/sim/executor/execution/state'
import type { BlockStateController, ContextExtensions } from '@/lib/sim/executor/execution/types'
import type { ExecutionContext, NormalizedBlockOutput } from '@/lib/sim/executor/types'
import type { LoopConfigWithNodes } from '@/lib/sim/executor/types/loop'
import { createReferencePattern } from '@/lib/sim/executor/utils/reference-validation'
import { projectResolvedSecretDiagnosticError } from '@/lib/sim/executor/utils/resolved-secret-content-projection'
import { mergeSubflowSecretProvenance } from '@/lib/sim/executor/utils/subflow-secret-provenance'
import {
  addSubflowErrorLog,
...
import { resolveArrayInputAsync } from '@/lib/sim/executor/utils/subflow-utils.server'
import type { VariableResolver } from '@/lib/sim/executor/variables/resolver'
