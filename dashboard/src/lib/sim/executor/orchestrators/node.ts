// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/orchestrators/node.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { isLargeValueRef } from '@/lib/sim/core/execution/payloads/large-value-ref'
import { EDGE } from '@/lib/sim/executor/constants'
import type { DAG, DAGNode } from '@/lib/sim/executor/dag/builder'
import type { BlockExecutor } from '@/lib/sim/executor/execution/block-executor'
import type { BlockStateController } from '@/lib/sim/executor/execution/types'
import type { LoopOrchestrator } from '@/lib/sim/executor/orchestrators/loop'
import type { ParallelOrchestrator } from '@/lib/sim/executor/orchestrators/parallel'
