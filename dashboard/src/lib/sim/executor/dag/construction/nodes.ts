// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/dag/construction/nodes.ts; adapted for Breadboard.
import { BlockType, isMetadataOnlyBlockType } from '@/lib/sim/executor/constants'
import type { DAG } from '@/lib/sim/executor/dag/builder'
import { buildBranchNodeId } from '@/lib/sim/executor/utils/subflow-utils'
