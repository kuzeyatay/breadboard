// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/dag/construction/paths.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { isMetadataOnlyBlockType, isTriggerBlockType } from '@/lib/sim/executor/constants'
import { extractBaseBlockId } from '@/lib/sim/executor/utils/subflow-utils'
