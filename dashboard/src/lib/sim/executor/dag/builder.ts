// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/executor/dag/builder.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { EdgeConstructor } from '@/lib/sim/executor/dag/construction/edges'
import { LoopConstructor } from '@/lib/sim/executor/dag/construction/loops'
import { NodeConstructor } from '@/lib/sim/executor/dag/construction/nodes'
import { ParallelConstructor } from '@/lib/sim/executor/dag/construction/parallels'
import { PathConstructor } from '@/lib/sim/executor/dag/construction/paths'
import type { DAGEdge, NodeMetadata } from '@/lib/sim/executor/dag/types'
import {
