// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/types.ts; adapted for Breadboard.
...
import type {
  ...
  PrimitiveValueType,
  SubBlockType,
} from '@/lib/sim/workflow-types/blocks'
import type { SelectorKey } from '@/lib/sim/core/selectors-types'
...
export { isHiddenFromDisplay } from '@/lib/sim/workflow-types/blocks'
