// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/custom/build-config.ts; adapted for Breadboard.
import type { SubBlockType } from '@/lib/sim/workflow-types/blocks'
import type { WorkflowInputField } from '@/lib/sim/core/workflows/input-format'
import type { BlockConfig, BlockIcon, SubBlockConfig } from '@/lib/sim/blocks/types'
