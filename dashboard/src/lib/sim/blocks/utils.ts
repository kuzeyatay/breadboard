// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/utils.ts; adapted for Breadboard.
import { toError } from '@/lib/sim/core/utils/errors'
import { SimAutoIcon } from '@/lib/sim/blocks/icons'
import {
  isAzureConfigured,
  isCohereConfigured,
  isHosted,
  isOllamaConfigured,
} from '@/lib/sim/core/core/config/env-flags'
import { getScopesForService } from '@/lib/sim/core/oauth/utils'
import { containsReference } from '@/lib/sim/core/workflows/sanitization/references'
...
import {
  ...
  SIM_AUTO_MODEL_ID,
} from '@/lib/sim/providers/models'
import { isPiSupportedModel } from '@/lib/sim/providers/pi-providers'
import type { ProviderId } from '@/lib/sim/providers/types'
import { getProviderFromModel } from '@/lib/sim/providers/utils'
import { useProvidersStore } from '@/lib/sim/core/stores/providers/store'
