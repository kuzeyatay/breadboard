// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/blocks/evaluator.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { ChartBarIcon } from '@/lib/sim/blocks/icons'
import type { BlockConfig, ParamType } from '@/lib/sim/blocks/types'
import {
  getModelOptions,
