// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/blocks/function.ts; adapted for Breadboard.
import { CodeIcon } from '@/lib/sim/blocks/icons'
import { isSandboxesEnabled } from '@/lib/sim/core/core/config/env-flags'
import { CodeLanguage, getLanguageDisplayName } from '@/lib/sim/core/execution/languages'
import {
  fetchWorkspaceSandboxOption,
  fetchWorkspaceSandboxOptions,
  fetchWorkspaceSecretNameOptions,
} from '@/lib/sim/core/workflows/subblocks/options'
import type { BlockConfig } from '@/lib/sim/blocks/types'
import type { CodeExecutionOutput } from '@/lib/sim/core/tools-shim/function/types'
