// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/blocks/router.ts; adapted for Breadboard.
import { ConnectIcon } from '@/lib/sim/blocks/icons'
import { AuthMode, type BlockConfig } from '@/lib/sim/blocks/types'
import {
  getModelOptions,
