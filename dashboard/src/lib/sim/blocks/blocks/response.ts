// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/blocks/response.ts; adapted for Breadboard.
import { ResponseIcon } from '@/lib/sim/blocks/icons'
import type { BlockConfig } from '@/lib/sim/blocks/types'
import type { ResponseBlockOutput } from '@/lib/sim/core/tools-shim/response/types'
