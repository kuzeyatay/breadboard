// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/blocks/blocks/api.ts; adapted for Breadboard.
import { ApiIcon } from '@/lib/sim/blocks/icons'
import type { BlockConfig } from '@/lib/sim/blocks/types'
import { IntegrationType } from '@/lib/sim/blocks/types'
import type { RequestResponse } from '@/lib/sim/core/tools-shim/http/types'
