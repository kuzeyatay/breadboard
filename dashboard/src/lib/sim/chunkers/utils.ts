// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/chunkers/utils.ts;
// adapted for Breadboard (relative `.ts` imports so `node --test
// --experimental-strip-types` can resolve them).
