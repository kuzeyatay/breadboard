// Vendored from simstudioai/sim (Apache-2.0) — packages/workflow-renderer/src/workflow-block/inline-chip.tsx; adapted for Breadboard.
import type { ReactNode } from 'react'
import { ChipTag, cn } from '../emcn'
