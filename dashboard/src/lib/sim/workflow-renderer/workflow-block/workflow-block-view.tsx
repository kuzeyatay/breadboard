// Vendored from simstudioai/sim (Apache-2.0) — packages/workflow-renderer/src/workflow-block/workflow-block-view.tsx; adapted for Breadboard.
import {
  type ComponentType,
  type CSSProperties,
  type HTMLAttributes,
...
import { Badge, ChipTag, cn, handleKeyboardActivation, Switch, Tooltip } from '../emcn'
import { Ban, Lock } from '../emcn/icons'
import {
