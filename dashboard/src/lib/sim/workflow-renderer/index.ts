// Vendored from simstudioai/sim (Apache-2.0) — packages/workflow-renderer/src/index.ts; adapted for Breadboard.
// Breadboard adaptation: the note and subflow views are not vendored (notes
// depend on streamdown; loop/parallel containers are out of the v1 canvas).
export {
  BLOCK_Z_BASE,
  CONNECTION_PICKER_Z,
