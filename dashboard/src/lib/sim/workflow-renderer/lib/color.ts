// Vendored from simstudioai/sim (Apache-2.0) — packages/utils/src/color.ts; adapted for Breadboard.
 ...
 * `white`/`black` keywords. Returns `null` for anything else so callers can
 * treat unknown values explicitly instead of guessing.
 */
