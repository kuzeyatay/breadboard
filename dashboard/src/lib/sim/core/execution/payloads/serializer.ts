// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/execution/payloads/serializer.ts; adapted for Breadboard.
import { PayloadSizeLimitError } from '@/lib/sim/core/core/utils/stream-limits'
...
import { type LargeValueStoreContext, storeLargeValue } from '@/lib/sim/core/execution/payloads/store'
import type { BlockLog } from '@/lib/sim/executor/types'
