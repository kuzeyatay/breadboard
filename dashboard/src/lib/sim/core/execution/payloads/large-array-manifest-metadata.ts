// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/execution/payloads/large-array-manifest-metadata.ts; adapted for Breadboard.
import { isLargeValueRef, type LargeValueRef } from '@/lib/sim/core/execution/payloads/large-value-ref'
