// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/core/utils/stream-limits.ts; adapted for Breadboard.
import { toError } from '@/lib/sim/core/utils/errors'
import { containsNulCharacter } from '@/lib/sim/core/utils/string'
