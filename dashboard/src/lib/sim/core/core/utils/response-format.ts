// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/core/utils/response-format.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { materializeLargeValueRefSyncOrThrow } from '@/lib/sim/core/execution/payloads/cache'
