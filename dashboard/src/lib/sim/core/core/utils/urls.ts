// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/core/utils/urls.ts; adapted for Breadboard.
import { isLoopbackHostname } from '@/lib/sim/core/security/hostnames'
import { env, getEnv } from '@/lib/sim/core/core/config/env'
import { isProd } from '@/lib/sim/core/core/config/env-flags'
