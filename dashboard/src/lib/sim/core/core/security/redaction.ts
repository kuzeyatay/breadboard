// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/core/security/redaction.ts; adapted for Breadboard.
/**
 * Centralized redaction utilities for sensitive data
 */

import { filterUserFileForDisplay, isUserFile } from '@/lib/sim/core/core/utils/user-file'
