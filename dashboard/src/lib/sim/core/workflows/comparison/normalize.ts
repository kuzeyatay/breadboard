// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/workflows/comparison/normalize.ts; adapted for Breadboard.
/**
...
} from '@/lib/sim/workflow-types/workflow'
import type { Edge } from 'reactflow'
import { isNonEmptyValue } from '@/lib/sim/core/workflows/subblocks/visibility'
import { isSyntheticToolSubBlockId } from '@/lib/sim/core/workflows/tool-input/synthetic-subblocks'
import type {
  BlockState,
  Loop,
  Parallel,
  Variable,
  WorkflowState,
} from '@/lib/sim/core/stores/workflows/workflow/types'
import { SYSTEM_SUBBLOCK_IDS, TRIGGER_RUNTIME_SUBBLOCK_IDS } from '@/lib/sim/triggers/constants'
