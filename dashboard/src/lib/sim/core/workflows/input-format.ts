// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/workflows/input-format.ts; adapted for Breadboard.
import { generateId } from '@/lib/sim/core/utils/id'
import { isInternalFileUrl, parseInternalFileUrl } from '@/lib/sim/core/uploads/utils/file-utils'
