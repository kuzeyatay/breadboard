// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/workflows/blocks/block-outputs.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import {
  extractFieldsFromSchema,
  parseResponseFormatSafely,
} from '@/lib/sim/core/core/utils/response-format'
import { normalizeInputFormatValue } from '@/lib/sim/core/workflows/input-format'
import {
  classifyStartBlockType,
  StartBlockPath,
  TRIGGER_TYPES,
} from '@/lib/sim/core/workflows/triggers/triggers'
import {
  type InputFormatField,
  START_BLOCK_RESERVED_FIELDS,
  USER_FILE_ACCESSIBLE_PROPERTIES,
  USER_FILE_PROPERTY_TYPES,
} from '@/lib/sim/core/workflows/types'
...
import { getToolOutputsMetadata } from '@/lib/sim/core/tools-shim/metadata-outputs'
