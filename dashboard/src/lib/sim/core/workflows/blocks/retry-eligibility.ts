// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/workflows/blocks/retry-eligibility.ts; adapted for Breadboard.
import { BlockType, isMetadataOnlyBlockType, isSentinelBlockType } from '@/lib/sim/executor/constants'
