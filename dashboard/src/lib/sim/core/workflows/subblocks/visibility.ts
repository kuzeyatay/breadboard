// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/workflows/subblocks/visibility.ts; adapted for Breadboard.
import { getEnv, isTruthy } from '@/lib/sim/core/core/config/env'
import { isHosted } from '@/lib/sim/core/core/config/env-flags'
