// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/workflows/triggers/trigger-utils.ts; adapted for Breadboard.
import { createLogger } from '@/lib/sim/core/logger'
import { toError } from '@/lib/sim/core/utils/errors'
import { isInputDefinitionTrigger } from '@/lib/sim/core/workflows/triggers/input-definition-triggers'
import { generateMockPayloadFromOutputsDefinition } from '@/lib/sim/core/workflows/triggers/mock-payload'
import { type StartBlockCandidate, StartBlockPath } from '@/lib/sim/core/workflows/triggers/triggers'
import { getAllBlocks, getBlock } from '@/lib/sim/blocks'
import type { BlockConfig } from '@/lib/sim/blocks/types'
import type { BlockState, WorkflowState } from '@/lib/sim/core/stores/workflows/workflow/types'
