// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/lib/workflows/sanitization/references.ts; adapted for Breadboard.
import { normalizeName, REFERENCE } from '@/lib/sim/executor/constants'
