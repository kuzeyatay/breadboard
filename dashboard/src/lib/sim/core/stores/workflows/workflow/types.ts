// Vendored from simstudioai/sim (Apache-2.0) — apps/sim/stores/workflows/workflow/types.ts; adapted for Breadboard.
import type {
  BlockData,
  BlockLayoutState,
  BlockRetryConfig,
...
export { isValidSubflowType, SUBFLOW_TYPES } from '@/lib/sim/workflow-types/workflow'
