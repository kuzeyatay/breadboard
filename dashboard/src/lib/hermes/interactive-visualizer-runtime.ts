...
html[data-presentation="inline"],html[data-presentation="inline"] body{min-height:0;background:transparent}html[data-presentation="inline"] body{padding:4px 0 8px}html[data-presentation="inline"] #app{max-width:none}html[data-presentation="inline"] .iv-description{display:none}
