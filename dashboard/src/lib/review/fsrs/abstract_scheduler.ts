...
import { dateDiffInDays, Grades } from './help.ts'
import {
  type Card,
  type CardInput,
  type DateInput,
...
import { DefaultInitSeedStrategy } from './strategies/index.ts'
import {
  StrategyMode,
  type TSeedStrategy,
  type TStrategyHandler,
} from './strategies/types.ts'
import type { IPreview, IScheduler } from './types.ts'
...
export abstract class AbstractScheduler implements IScheduler {
  ...
  private init() {
    ...
    this.algorithm.seed = (seed_strategy as TSeedStrategy).call(this)
  }
