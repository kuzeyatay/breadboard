...
test("dashboard test discovery partitions the exact real-browser lane", () => {
  ...
  assert.deepEqual(partition.browser, [
    ...
    "chat-auto-scroll-browser.test.mjs",
    "chat-history-reading-browser.test.mjs",
    ...
    "messaging-notifications-ui.test.mjs",
    "notification-view-presence-ui.test.mjs",
    "notification-sound-ui.test.mjs",
    "pdf-assistant-interaction-ui.test.mjs",
    "pdf-background-save-ui.test.mjs",
    "provider-usage-refresh-ui.test.mjs",
    "max-research-interruption-ui.test.mjs",
    "garden-response-completion-ui.test.mjs",
    "garden-retry-reload-ui.test.mjs",
  ]);
  assert.deepEqual(
