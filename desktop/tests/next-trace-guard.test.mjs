...
test("the production trace policy excludes data and build roots without touching program roots", () => {
  ...
  const denied = [
    ...
    "hyperframes-browser/.cache/hyperframes/chrome/chrome.exe",
    "hyperframes-runs/run.json",
    "install-speech.mjs",
    "loopx-goals/goal.json",
    "openmaic-data/breadboard-service.json",
    ...
    "runtime/teach/speech/venv/Lib/site-packages/anyio/__init__.py",
    ...
    "output/report.json",
    "output/thought-menu-qa/recovery-375.png",
    "output/thought-menu-qa/timeline-1165.png",
    "neumorphic-before/screenshot.png",
    "neumorphic-after/screenshot.png",
    "scripts/build-helper.mjs",
    "third-party/bambu-printer-mcp/LICENSE",
    "third-party/bambu-printer-mcp/NOTICE.md",
    "third-party/bambu-printer-mcp/upstream/bambu.ts.source",
    "third-party/bambu-printer-mcp/upstream/package.json",
    ".next/server/app.js",
  ...
  const allowed = [
    ...
    "src/lib/bambu/runtime-client.ts",
    "public/breadboard.svg",
    "public/output/asset.png",
    "src/lib/output/formatter.ts",
    "node_modules/dependency/output/index.js",
